...
func (o *StaticSipTrunkResponse) GetLocation() string {
...
// and a boolean to check if the value has been set.
func (o *StaticSipTrunkResponse) GetLocationOk() (*string, bool) {
	if o == nil || IsNil(o.Location) {
		return nil, false
	}
...
func (o *StaticSipTrunkResponse) SetLocation(v string) {
	o.Location = &v
}
