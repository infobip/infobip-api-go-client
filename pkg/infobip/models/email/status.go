...
func (o *Status) GetGroupId() int32 {
...
func (o *Status) GetGroupIdOk() (*int32, bool) {
	if o == nil || IsNil(o.GroupId) {
		return nil, false
	}
...
func (o *Status) SetGroupId(v int32) {
	o.GroupId = &v
}

// GetGroupName returns the GroupName field value if set, zero value otherwise.
func (o *Status) GetGroupName() string {
...
// and a boolean to check if the value has been set.
func (o *Status) GetGroupNameOk() (*string, bool) {
	if o == nil || IsNil(o.GroupName) {
		return nil, false
	}
...
func (o *Status) HasGroupName() bool {
	if o != nil && !IsNil(o.GroupName) {
		return true
	}
...
func (o *Status) SetGroupName(v string) {
	o.GroupName = &v
}
...
func (o *Status) GetAction() string {
...
// and a boolean to check if the value has been set.
func (o *Status) GetActionOk() (*string, bool) {
	if o == nil || IsNil(o.Action) {
		return nil, false
	}
...
func (o *Status) SetAction(v string) {
	o.Action = &v
}
