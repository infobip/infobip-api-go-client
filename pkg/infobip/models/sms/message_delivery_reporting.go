...
func (o *MessageDeliveryReporting) GetNotify() bool {
...
// and a boolean to check if the value has been set.
func (o *MessageDeliveryReporting) GetNotifyOk() (*bool, bool) {
	if o == nil || IsNil(o.Notify) {
		return nil, false
	}
...
func (o *MessageDeliveryReporting) HasNotify() bool {
	if o != nil && !IsNil(o.Notify) {
		return true
	}
...
func (o *MessageDeliveryReporting) SetNotify(v bool) {
	o.Notify = &v
}
