...
func NewEventRequest(events []Event) *EventRequest {
	this := EventRequest{}
	this.Events = events
	return &this
}
...
func (o *EventRequest) GetEvents() []Event {
	if o == nil {
		var ret []Event
		return ret
	}
...
func (o *EventRequest) GetEventsOk() ([]Event, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EventRequest) SetEvents(v []Event) {
	o.Events = v
}
