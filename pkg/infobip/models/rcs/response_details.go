...
func (o *ResponseDetails) GetDetails() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ResponseDetails) GetDetailsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Details) {
...
func (o *ResponseDetails) SetDetails(v map[string]interface{}) {
	o.Details = v
}
