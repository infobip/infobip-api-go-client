...
// checks if the InboundEvent type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InboundEvent{}

// InboundEvent Collection of mobile originated events.
...
type _InboundEvent InboundEvent

// NewInboundEvent instantiates a new InboundEvent object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed

func NewInboundEvent(sender string, to string, integrationType string, receivedAt Time, messageId string, message InboundMessageContent, price MessagePrice) *InboundEvent {
	this := InboundEvent{}
	this.Sender = sender
	this.To = to
...
// NewInboundEventWithDefaults instantiates a new InboundEvent object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInboundEventWithDefaults() *InboundEvent {
	this := InboundEvent{}
...
func (o *InboundEvent) GetEntityId() string {
...
func (o *InboundEvent) GetEntityIdOk() (*string, bool) {
	if o == nil || IsNil(o.EntityId) {
		return nil, false
	}
...
func (o *InboundEvent) HasEntityId() bool {
	if o != nil && !IsNil(o.EntityId) {
		return true
	}
...
func (o *InboundEvent) SetEntityId(v string) {
	o.EntityId = &v
}

// GetApplicationId returns the ApplicationId field value if set, zero value otherwise.
func (o *InboundEvent) GetApplicationId() string {
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetApplicationIdOk() (*string, bool) {
	if o == nil || IsNil(o.ApplicationId) {
		return nil, false
	}
...
func (o *InboundEvent) HasApplicationId() bool {
	if o != nil && !IsNil(o.ApplicationId) {
		return true
	}
...
func (o *InboundEvent) SetApplicationId(v string) {
	o.ApplicationId = &v
}

// GetSender returns the Sender field value
func (o *InboundEvent) GetSender() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetSenderOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InboundEvent) SetSender(v string) {
	o.Sender = v
}

// GetTo returns the To field value
func (o *InboundEvent) GetTo() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetToOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.To, true
...
func (o *InboundEvent) SetTo(v string) {
	o.To = v
}

// GetIntegrationType returns the IntegrationType field value
func (o *InboundEvent) GetIntegrationType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetIntegrationTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InboundEvent) SetIntegrationType(v string) {
	o.IntegrationType = v
}

// GetReceivedAt returns the ReceivedAt field value
func (o *InboundEvent) GetReceivedAt() Time {
	if o == nil {
		var ret Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetReceivedAtOk() (*Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InboundEvent) SetReceivedAt(v Time) {
	o.ReceivedAt = v
}

// GetKeyword returns the Keyword field value if set, zero value otherwise.
func (o *InboundEvent) GetKeyword() string {
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetKeywordOk() (*string, bool) {
	if o == nil || IsNil(o.Keyword) {
		return nil, false
	}
...
func (o *InboundEvent) HasKeyword() bool {
	if o != nil && !IsNil(o.Keyword) {
		return true
	}
...
func (o *InboundEvent) SetKeyword(v string) {
	o.Keyword = &v
}

// GetMessageId returns the MessageId field value
func (o *InboundEvent) GetMessageId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetMessageIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InboundEvent) SetMessageId(v string) {
	o.MessageId = v
}

// GetPairedMessageId returns the PairedMessageId field value if set, zero value otherwise.
func (o *InboundEvent) GetPairedMessageId() string {
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetPairedMessageIdOk() (*string, bool) {
	if o == nil || IsNil(o.PairedMessageId) {
		return nil, false
	}
...
func (o *InboundEvent) HasPairedMessageId() bool {
	if o != nil && !IsNil(o.PairedMessageId) {
		return true
	}
...
func (o *InboundEvent) SetPairedMessageId(v string) {
	o.PairedMessageId = &v
}

// GetCallbackData returns the CallbackData field value if set, zero value otherwise.
func (o *InboundEvent) GetCallbackData() string {
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetCallbackDataOk() (*string, bool) {
	if o == nil || IsNil(o.CallbackData) {
		return nil, false
	}
...
func (o *InboundEvent) HasCallbackData() bool {
	if o != nil && !IsNil(o.CallbackData) {
		return true
	}
...
func (o *InboundEvent) SetCallbackData(v string) {
	o.CallbackData = &v
}

// GetMessage returns the Message field value
func (o *InboundEvent) GetMessage() InboundMessageContent {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetMessageOk() (*InboundMessageContent, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InboundEvent) SetMessage(v InboundMessageContent) {
	o.Message = v
}

// GetPrice returns the Price field value
func (o *InboundEvent) GetPrice() MessagePrice {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *InboundEvent) GetPriceOk() (*MessagePrice, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Price, true
...
func (o *InboundEvent) SetPrice(v MessagePrice) {
	o.Price = v
}

func (o InboundEvent) MarshalJSON() ([]byte, error) {
...
func (o InboundEvent) ToMap() (map[string]interface{}, error) {
